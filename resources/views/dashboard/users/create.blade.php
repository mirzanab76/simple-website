...
<div class="col-lg-8">
<form method="post" action="/dashboard/users" class="mb-3" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        <input class="form-check-input @error('is_admin') is-invalid @enderror" type="radio" name="is_admin" id="adminTrue" value="1" disabled>
